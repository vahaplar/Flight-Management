...
public class AirlineManagement extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AirlineManagement frame = new AirlineManagement();
	...
	public AirlineManagement() {
		...
		btnFlight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				fm.setVisible(true);
				AirlineManagement.this.dispose();
			}
		});
		panel.add(btnFlight);
		...
		btnAirline.setBorderPainted(true);
		...
		JLabel airlineCodeLabel = new JLabel("Airline Code");
		airlineCodeLabel.setBounds(47, 31, 76, 16);
		panel_2.add(airlineCodeLabel);

		JLabel airlineNameLabel = new JLabel("Airline Name");
		airlineNameLabel.setBounds(47, 71, 82, 16);
		panel_2.add(airlineNameLabel);

		airlineCodeField = new JTextField();
		airlineCodeField.setBounds(135, 28, 116, 22);
		panel_2.add(airlineCodeField);
		airlineCodeField.setColumns(10);

		airlineNameField = new JTextField();
		airlineNameField.setColumns(10);
		airlineNameField.setBounds(135, 68, 116, 22);
		panel_2.add(airlineNameField);
		...
		JTextPane searchAirline = new JTextPane();
		searchAirline.setFont(new Font("Tahoma", Font.PLAIN, 20));
		panel_3.add(searchAirline);
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "select airline_code as 'Airline Code',airline_name as 'Airline Name' from airline where airline_name like '%"
							+ searchAirline.getText() + "%'";
					pst = conn.prepareStatement(sql);
					rs = pst.executeQuery();

					airlineTable.setModel(DbUtils.resultSetToTableModel(rs));
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "INSERT INTO airline (airline_code, airline_name) VALUES (?, ?)";

					pst = conn.prepareStatement(sql);

					pst.setString(1, airlineCodeField.getText());
					pst.setString(2, airlineNameField.getText());
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sqlArr = "update airline set airline_code=?, airline_name=? where airline_code=? ";
		...
		airlineTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int i = airlineTable.getSelectedRow();
				tableIndex = airlineTable.getValueAt(i, 0).toString();
				airlineCodeField.setText(airlineTable.getValueAt(i, 0).toString());
				airlineNameField.setText(airlineTable.getValueAt(i, 1).toString());
			}
		});
